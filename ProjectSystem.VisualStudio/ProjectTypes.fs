...
open Microsoft.VisualStudio.ProjectSystem.VS.Properties
...
[<Export>]
[<AppliesTo(Capabilities.fsproj)>]    
type FSharpConfiguredProject [<ImportingConstructor>] 
    ( configuredProject:ConfiguredProject,properties:FSharpProjectProperties) =
