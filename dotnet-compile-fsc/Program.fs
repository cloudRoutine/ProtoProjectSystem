...
module CompileFscCommand =
    ...
    let resolveFsc (fscArgs: string ResizeArray) (temp:string) : FscCommandSpec =
        let nugetPackagesRoot = PackageDependencyProvider(NuGetPathContext.Create(String.Empty),FrameworkReferenceResolver.Default)
        ...
        let depsJsonCommandResolver = DepsJsonCommandResolver String.Empty
        ...
        copyRuntimeConfigForFscExe (runtimeConfigFile, "fsc", depsFile, String.Empty, fscPath)
